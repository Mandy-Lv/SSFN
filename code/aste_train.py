...
class ASTE(pl.LightningModule):
    ...
    def add_model_specific_args(parser):
        ...
        parser.add_argument('--dataset', type=str, default="15res", help='dataset')
        ...
        parser.add_argument("--fusion_type", default='add', type=str, choices=['add', 'mul'], help="Fusion type for table and pos_quant_matrix")  # 新增
        return parser
